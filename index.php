...
<body id='home'>
    ...
    <p> 
      ...
      <a href="http://www.darkscience.ws/">DarkScience IRC Network</a> in the
      channel #IdleRPG. 
    </p>
   </div> 
	...
	<h2></h2>
      ...
      follow, so the stats for this feature may change in the future.</p>
			...
			<div class='sec'>
    <a name="info"></a><h1>Obtaining Bot Info</h1>
   <h2></h2> 
   ...
   <h2></h2> 
      ...
      <p>This is a p0 (see <a href="#penalties">Penalties</a>) command.</p>
			...
			<div class='sec'>
    <a name="penalties"></a><h1>Penalties</h1>
   <h2></h2> 
   ...
   <h2></h2> 
      ...
      <a href="#stealing">stolen</a>.</p>
			...
			<div class='sec'>
    <a name="uniqueitems"></a><h1>Unique Items</h1>
   <h2></h2> 
   ...
   <h2></h2> 
      ...
      whim.</p>
			...
			<div class='sec'>
    <a name="critstrike"></a><h1>Critical Strike</h1>
   <h2></h2> 
   ...
   <h2></h2> 
      ...
      punishment.</p>
			...
			<div class='sec'>
    <a name="grid"></a><h1>Grid System</h1>
   <h2></h2> 
      ...
      don't want to fall down and risk a Realm-wide p15!).</p>
			...
			<div class='sec'>
    <a name="stealing"></a><h1>Item Stealing</h1>
   <h2></h2> 
